...
Este último gráfico representa de forma mucho mas precisa la distribución homicidios dolosos por habitante en cada provincia. Podemos ver que si bien Neuquén sigue teniendo la mayor cantidad de casos, Santa Cruz tiene una relación de homicidios/habitantes un poco más alta de la que veíamos en el gráfico anterior.
