...
Vamos a hacer el gráfico de frecuencia de casos anuales pero introduciendo también la variable provincia. Repitamos el primer gráfico que hicimos pero con algunos cambios. Vamos a usar geom_col para indicar que hacemos un gráfico de barras con un eje `y` definido por nosotros, asignándole al atributo `fill` la variable provincia, y el valor `fill` al atributo `position` dentro de la geometría. 
...
Podemos destacar que Santa Cruz tuvo la tasa más alta de víctimas por caso en el año 2020.
